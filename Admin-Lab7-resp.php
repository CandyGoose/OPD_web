...
?>
            ...
            <ul class="professions" id="users">
                '<li style="background-color: #F9F9F9; border-radius: 10px; padding: 20px;">
                    <div style="display: flex; align-items: center; margin-bottom: 10px;">
                        ...
                        <a href="./Admin-Lab7-pvk.php?id='+ id +'" style="display: inline-block; background-color: #00CC66; color: white; text-decoration: none; padding: 10px 20px; border-radius: 5px;">Посмотреть результаты</a>
                    </div>
                </li>'
            </ul>
        </div>
    ...
    <script src="./js/admin-users-result2.js"></script>
